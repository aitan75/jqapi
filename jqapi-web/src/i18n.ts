...
export const messages: Record<Language, Messages> = {
  ...
  it: {
    ...
    errors: { INPUT_LIMIT_EXCEEDED: 'Il circuito supera i limiti supportati dalla simulazione.', INVALID_CIRCUIT_SPEC: 'Il circuito contiene una porta o una configurazione non valida.', INVALID_SHOT_COUNT: 'Scegli un numero intero di ripetizioni da 1 a 10.000.', SIMULATION_FAILED: 'Non è stato possibile simulare il circuito. Riprova.', UNSUPPORTED_SPEC_VERSION: 'Questo editor non supporta il formato del circuito o le sue operazioni classiche.' },
    presets: {
