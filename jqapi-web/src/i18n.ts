...
export const messages: Record<Language, Messages> = {
  en: {
    ...
    errors: { INPUT_LIMIT_EXCEEDED: 'The circuit exceeds the supported simulation limits.', INVALID_CIRCUIT_SPEC: 'The circuit contains an invalid gate or configuration.', INVALID_SHOT_COUNT: 'Choose a whole number of shots from 1 to 10,000.', SIMULATION_FAILED: 'The circuit could not be simulated. Please try again.', UNSUPPORTED_SPEC_VERSION: 'The circuit uses an unsupported format version.' },
    presets: {
  ...
  it: {
    ...
    errors: { INPUT_LIMIT_EXCEEDED: 'Il circuito supera i limiti supportati dalla simulazione.', INVALID_CIRCUIT_SPEC: 'Il circuito contiene una porta o una configurazione non valida.', INVALID_SHOT_COUNT: 'Scegli un numero intero di ripetizioni da 1 a 10.000.', SIMULATION_FAILED: 'Non è stato possibile simulare il circuito. Riprova.', UNSUPPORTED_SPEC_VERSION: 'Il circuito usa una versione del formato non supportata.' },
    presets: {
