...
export const messages: Record<Language, Messages> = {
  en: {
    language: 'Language', languages: { en: 'English', it: 'Italiano' }, gates: 'Gates', algorithms: 'Algorithms',
  ...
  it: {
    language: 'Lingua', languages: { en: 'English', it: 'Italiano' }, gates: 'Porte', algorithms: 'Algoritmi',
