...
- **OpenQASM 2** — [import/export guide](docs/manual/openqasm.md), [supported subset and limits](docs/api/openqasm.md). Includes measurement, reset, and one-bit classical conditions.
